#!/usr/bin/env python3
"""
Tests for child preservation and expansion state during filtering.
Verifies that exception children remain visible and expansion state is preserved.
"""
...
class TestChildPreservation:
    """Test cases for preserving exception children during filtering operations."""
